...
(function (undefined) {
    ...
    function newContext(contextName) {
        ...
        function callPlugin(pluginName, depManager) {
            var map = depManager.map,
                fullName = map.fullName,
                name = map.name,
                plugin = plugins[pluginName] || (plugins[pluginName] = defined[pluginName]),
                load;
        ...
        function getManager(map, shouldQueue) {
            var fullName = map.fullName,
                prefix = map.prefix,
                plugin = prefix ? plugins[prefix] || (plugins[prefix] = defined[prefix]) : null,
                manager,
                created,
                pluginManager,
                prefixMap;
         ...
         */
        jQueryCheck = function jQueryCheck(jqCandidate) {
            if (!context.jQuery) {
        ...
        context = {
            ...
            requireDefined: function requireDefined(moduleName, relModuleMap) {
                return makeModuleMap(moduleName, relModuleMap).fullName in defined;
            },

            requireSpecified: function requireSpecified(moduleName, relModuleMap) {
                return makeModuleMap(moduleName, relModuleMap).fullName in specified;
            },

            require: function require(deps, callback, relModuleMap) {
             ...
             * defQueue.
             */
            takeGlobalQueue: function takeGlobalQueue() {
             ...
             */
            toUrl: function toUrl(moduleNamePlusExt, relModuleMap) {
             ...
             */
            nameToUrl: function nameToUrl(moduleName, ext, relModuleMap) {
                var paths,
                    pkgs,
                    pkg,
                    pkgPath,
     ...
     */
    req = requirejs = function requirejs(deps, callback) {
